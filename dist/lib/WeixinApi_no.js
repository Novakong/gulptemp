...
(function(){
	...
	share.content = {
		...
		link: 'http://campaign.olay.com.cn/2016olaycny/',
		desc: '',
	...
	$.ajax({
	    type:'POST',
	    url:"http://campaign.olay.com.cn/2016olaycny/act/?type=getShareId",
	    success:function(data){
	      var da = JSON.parse(data);
	      if(da.result == "0" || da.result == 0){
	        share.content.link = 'http://campaign.olay.com.cn/2016olaycny/?shareid=' + da.shareid;
