...
var kl = kp({
  list:[
    ...
    {src: 'http://bos.bj.baidubce.com/we-gd/olay/2016cny/img/award/bg.jpg'},
    {src: 'http://bos.bj.baidubce.com/we-gd/olay/2016cny/img/award/btn.png'},
    {src: 'http://bos.bj.baidubce.com/we-gd/olay/2016cny/img/award/code.png'},
    {src: 'http://bos.bj.baidubce.com/we-gd/olay/2016cny/img/award/detail_1.png'},
...
$(function(){
    ...
    $('.btn_getcoupon').on('touchstart', function(e){
      switch(aidx){
        case '1':_smq.push(['custom','start','olay1']);
          gaClick('applygift-skin');
          break;
        case '1':_smq.push(['custom','start','olay4']);
          gaClick('applygift-young');
          break;
        case '1':_smq.push(['custom','start','olay2']);
          gaClick('applygift-peach');
          break;
        case '1':_smq.push(['custom','start','YLY']);
          gaClick('applygift-qingxin');
          break;
        case '1':_smq.push(['custom','start','prox']);
          gaClick('applygift-dazzling');
          break;
        case '1':_smq.push(['custom','start','olay3']);
